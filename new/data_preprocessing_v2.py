...
#DATA_FEATURES_DIRECTORY = "../data/features"
...
def main():
    ...
    if not os.path.exists(DATA_STRUCTURED_DIRECTORY):
        ...
        exit("The structured data directory does not exist at {}.".format(DATA_STRUCTURED_DIRECTORY))
    if not os.path.exists(DATA_FEATURES_DIRECTORY):
        ...
        exit("The features data directory does not exist at {}.".format(DATA_FEATURES_DIRECTORY))
